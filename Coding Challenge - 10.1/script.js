...
const poll = {
  ...
  registerNewAnswer() {
    ...
    typeof answer === 'number' && answer > -1 && answer < this.answers.length && this.answers[answer]++;
...
// creating a object answers so that this keyword will take from parameters passed array
